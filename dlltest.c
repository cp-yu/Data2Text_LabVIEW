...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 12), // void()(double *, int, double *, int, char const *, char const *, char const *, char const *)
...
/*  5 */ _CFFI_OP(_CFFI_OP_POINTER, 10), // char const *
...
static void _cffi_d_ToText(double * x0, int x1, double * x2, int x3, char const * x4, char const * x5, char const * x6, char const * x7)
{
  ToText(x0, x1, x2, x3, x4, x5, x6, x7);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_ToText(PyObject *self, PyObject *args)
{
  double * x0;
  int x1;
  double * x2;
  ...
  if (!PyArg_UnpackTuple(args, "ToText", 8, 8, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7))
    return NULL;
...
#else
#  define _cffi_f_ToText _cffi_d_ToText
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "ToText", (void *)_cffi_f_ToText, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_ToText },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_dlltest(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_dlltest(void) { return NULL; }
#  else
     initdlltest(void) { }
#  endif
#  endif
...
PyInit_dlltest(void)
{
  return _cffi_init("dlltest", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initdlltest(void)
{
  _cffi_init("dlltest", 0x2601, &_cffi_type_context);
}
#endif
